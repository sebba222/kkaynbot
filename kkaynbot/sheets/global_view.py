...
def update_global():
    try:
        # force=True para leer datos frescos post-escritura; sin inv_cache() previo
        # (force=True ya bypasea el caché, inv_cache() era redundante)
        ...
        # Sin inv_cache() aquí: update_por_cuenta usa el caché fresco que acabamos de poblar
